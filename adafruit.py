...
mqtt_port = 1883
mqtt_username = 'carolzinha'
mqtt_password = 'aio_fJsZ97JHEB7tvamQCbKhRtujV8zQ' 
mqtt_topics = ['carolzinha/feeds/data-output', 'carolzinha/feeds/gas', 'carolzinha/feeds/metrics']
